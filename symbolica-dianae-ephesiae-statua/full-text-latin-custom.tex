...
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{motherworld.jpeg}}

\renewcommand\thefootnote{{\bfseries\large\color{customColor}{\arabic{footnote}}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{{\bfseries\large\color{customColor}#1}}}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.9\textheight,keepaspectratio]{figures/01.png}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[height=0.9\textheight,keepaspectratio]{figures/02.png}
\end{figure}
\clearpage
\begin{figure}[H]
\centering
\includegraphics[height=0.9\textheight,keepaspectratio]{figures/03.png}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[height=0.9\textheight,keepaspectratio]{figures/04.png}
\end{figure}
\clearpage
\ClearShipoutPictureBG
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{motherworld.jpeg}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth,keepaspectratio]{figures/26.png}
\end{figure}
\vspace*{\fill}
\clearpage
\ClearShipoutPictureBG
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth,keepaspectratio]{figures/27.png}
\end{figure}
\vspace*{\fill}
\clearpage
\ClearShipoutPictureBG
