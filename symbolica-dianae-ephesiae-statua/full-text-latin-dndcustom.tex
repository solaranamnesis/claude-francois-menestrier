...
\usepackage[main=latin,polutonikogreek]{babel}
...
\scshape Solar Anamnesis Edition% Publication year
	...
	{\scshape\small MIT License} % Publisher
\end{titlepage}
...
\begin{figure}[t]
\centering
\includegraphics[height=0.8\textheight,keepaspectratio]{figures/01.png}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[height=0.8\textheight,keepaspectratio]{figures/02.png}
\end{figure}
...
\hspace*{5mm}Ταὺ δορὶ, καὶ Μούσαις αἰπυτάταν Ἔφεσον;\\
...
\begin{quote}
\hspace*{0mm}Παῤῥαλίην Ἔφεσον, μεγάλην πόλιν ἰοχεαίρης,\\
\hspace*{0mm}Ἔνζα θεῆ ποτὲ νηὸν Ἀμαζονίδες τετύχοντο,\\
...
\hspace*{0mm}Ἐν πότε παῤῥαλίη Ἐφέσου βρέτας ἱδρύσαντο,\\
...
\DndDropCapLine{B}{inæ Victoriole Dee} pectus exornantes nos sollicitant, ut è sanctioribus Ephesiorum promptuarijs causas repetamus, ob quas præsertim Dianæ Ephesiæ Victorie tribuerentur. Etenim non sine mysterio id ab Ephesijs prestitum. Hoc enim argumento cuncta submitti Lune potestati innuebant. Vel certè corollas memoriam esse beneficiorum à Natura siue Cerere generi humano collatorum volebant. Expresse verò sunt alis passis, cum corollis et palmis, qui solitus est Victoriarum habitus, ut liquet ex Claudiano de Laud. Stil.
\begin{quote}
...
\DndDropCapLine{E}{ncarpi extrema querneæ} glandes tanquam elenchi coronant, quæ Cereris beneficia satis superque arguunt: cum in primis rerum incunabulis hoc fructuum genus mortalibus alimenta præbuerit; sed Cereris beneficio in meliora, et mitiora commutata fuerunt. Quod apertè declarat Ovidius in Fastis:
\begin{quote}
...
\clearpage
\section{Sphinges.}
\DndDropCapLine{U}{trumque Deæ latus} duæ Sphinges muniunt, quæ ab Ausoniana descriptione non discrepant: iuuat autem ipsummet vatem audire in ternario numero.
\begin{quote}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{figures/06.png}
\end{figure}
\vspace*{\fill}
\clearpage
\vspace*{\fill}
...
\clearpage
\twocolumn
\chapter{Lucae Holstenii Epistola ad Franciscum Cardinalem Barberinum de Fulcris seu verubus Dianæ Ephesiæ simulacro appositis.}
\begin{center}
...
\vspace*{\fill}
\clearpage
\chapter{Jo. Petri Bellorii Notæ in Numismata tum Ephesia, tum Aliarum Urbium Apibus Insignita.}
\begin{center}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/27.png}
\end{figure}
\vspace*{\fill}
\clearpage
\twocolumn
